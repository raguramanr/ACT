    ...
    // echo "Importing the Module to module - $_REQUEST[act_mod_name] <br><br>";
        ...
        $c = 0;
          while(($filesop = fgetcsv($handle, 5000, ",")) !== false)
          {
                ...
                $act_test_assigned_to   = $filesop[1];
                
		##Uncheck this for Updating Records
		$sql = "update $test_report_db set act_test_assigned_to='$act_test_assigned_to' where act_test_case_id='$act_test_case_id' and act_test_module='$_REQUEST[act_mod_name]'";
