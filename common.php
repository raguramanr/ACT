...
#                                                                                       #
#########################################################################################
$user_db = "act_user_account";
$test_report_db = "act_test_report";
$module_db = "act_test_module";
$tracker_db = "act_rt";
$admin_pwd_path = "/var/www/html/ACT/.passwords";
$user_pwd_path = "/var/www/html/ACTUser/.passwords";
$today = date("Y-m-d");
$target = 15;
$day_target = 3;
...
#                                                                                       #
#########################################################################################
$chart_include_path = "/var/www/html/ACT/Chart/Code/PHP/Includes";
$swf_file_path = "/var/www/html/ACT/Chart/Code/FusionCharts";
